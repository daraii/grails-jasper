...
<div id="content" role="main">
    <div class="container">
        <div class="row">
            <h1>Jasper Plugin Instructions/Demo Page</h1>

            <div class="col-12">
                <p>This Jasper Plugin allows you to launch reports built using
                    <a href="http://jasperforge.org/projects/jasperreports">Jasper Reports</a>
                    from within a Grails application.  This is done by making available a new GSP tag called <code>&lt;g:jasperReport&gt;</code>.</p>
                ...
                <p>If the <code>&lt;g:jasperReport&gt;</code> has a body, then the rendered HTML will be a &lt;form&gt; that includes that body.
                ...
                <p>If the <code>&lt;g:jasperReport&gt;</code> does not have a body, then the rendered HTML will be just a series of one or more &lt;a&gt; tags.
                </p>
            </div>
        </div>
        <hr class="divider"/>
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <pre><code>grails install-plugin jasper</code></pre>
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <g:jasperReport jasper="sample-jasper-plugin" format="PDF,HTML,XML,CSV,XLS,RTF,TEXT,ODT,ODS,DOCX,XLSX,PPTX" name="Parameter Example"
                                buttonPosition="bottom" bodyBefore=" " delimiter=" ">
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                Graph support is a common and useful feature used in reports. In Jasper/IReport the default chart library is <a
                    href="http://www.jfree.org/jfreechart/">JFreeChart</a>.<br/>The Grails Jasper Plugin supports JFreeChart reports. The link below shows an example of chart usage in Jasper reports.
                <br/>
                <g:jasperReport
                        controller="jasperDemo"
            ...
            "/>
                ...
                <pre>
                    ...
                    inline="true"
                    buttonPosition="bottom"&gt;
                    &lt;input type="hidden" name="HTML_HEADER" value="&lt;h1&gt;-----------Header-----------&lt;/h1&gt;" /&gt;
                    &lt;/g:jasperReport&gt;
                </pre>
                <br/>
        ...
        <div class="row">
            <h1>6. Controller Action Chaining</h1>
        ...
        <div class="row">
            <h1>7. Generate report with a service call</h1>
